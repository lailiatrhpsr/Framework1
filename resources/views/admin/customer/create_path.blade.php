...
@section('content')
<div class="container">
    <h2>Tambah Customer 2 (Penyimpanan File Path Gambar)</h2>
    <hr>
    
    <form action="{{ route('customer.store.path') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-success w-100 mt-2">Simpan Data Customer (File Path)</button>
            </div>
